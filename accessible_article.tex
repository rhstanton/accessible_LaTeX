...
\noindent \textbf{Checkers used so far:} Ally (the accessibility checker built into bCourses) and veraPDF (open-source PDF conformance validator, \urlu{https://verapdf.org/}).
