...
Whether you're creating slides or articles, these requirements are \tb{mostly the same}:
...
\hspace*{0.2in}pdfstandard=a-4f,\hspace*{0.27in}\% PDF/A-4f format (use a-4 for no embedded files)\\[0.5ex]
\hspace*{0.2in}pdfstandard=ua-2,\hspace*{0.26in}\% Add PDF/UA-2 conformance target\\[0.5ex]
