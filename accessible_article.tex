...
\begin{itemize}
\item \GreenText{Two templates:} Articles (\texttt{article} class) and slides (\texttt{ltx-talk})
...
\item \GreenText{Scores:} Perfect 100\% from the bCourses accessibility checker (Ally)
\end{itemize}
