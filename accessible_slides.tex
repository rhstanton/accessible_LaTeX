...
\AtBeginDocument{
  ...
  %
  % WHY: ltx-talk uses \section for organizational structure, but these
  % are often just markers, not true headings. Auto-tagging creates empty
  % H1 tags that trigger validator warnings.
  %
...
% Tag frame titles as H1 headings (the actual slide headings)
% This creates proper document structure for screen readers
