...
% Put section titles into list of PDF bookmarks
...
\RenewDocumentCommand{\section}{s o m}
  {%
    % Run the original \section, but suppress hyperref's automatic bookmark.
    \begingroup
    ...
    \endgroup
    % Now add exactly one bookmark, with the text you want.
    \IfBooleanTF{#1}
      {%
        \IfNoValueTF{#2}
...
% Put slide titles into list of PDF bookmarks

\ExplSyntaxOn
\int_new:N \g_rs_frame_bm_int
