...
%
% These fonts are included in modern TeX distributions (TeX Live 2023+)
...
\begin{frame}{This template}

\begin{itemize}
\item You can use {\color{blue}this template} for modifying your own work.
  \begin{itemize}
...
\begin{frame}{Getting started}
  \begin{itemize}
  \item \tb{\textbf{Follow these steps to migrate your Beamer slides:}}
