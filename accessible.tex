...
\item \textbf{\tb{Installing TeX Live (Free)}}
  ...
  \item \textbf{Windows}: Download TeX Live from \urlu{https://tug.org/texlive/}
    ...
    \item \textbf{Update}: Use \tg{TeX Live Manager} GUI from Start menu
    \end{itemize}
  \item \textbf{Mac}: Download MacTeX from \urlu{https://tug.org/mactex/}
    ...
    \item \textbf{Update}: Use \tg{TeX Live Utility} app (in Applications folder)
    \end{itemize}
  \end{itemize}
  
\bigskip

\item \textbf{\tb{Important:}} After installation, update all packages using the GUI updater shown above
...
\item \tb{TeX version requirements:}
    ...
    \item \tr{Will NOT work:} TeX Live 2022 or earlier, or Overleaf (as of Feb 2026)
    \end{itemize}
...
\tagpdfsetup{table/header-rows={1,2,3}}
  ...
  \toprule
  \color{blue} & \color{blue} & \color{blue} & \color{blue} & \color{blue}\multicolumn{1}{c}{Days} & \color{blue}Days in & \color{blue} & \color{blue} & \color{blue}\\
\color{blue}Payment & \color{blue}Caplet & \color{blue} & \color{blue}Forward & \color{blue}\multicolumn{1}{c}{to} & \color{blue}accrual & \color{blue} & \color{blue}\\
  \color{blue}date & \color{blue}expiry date & \color{blue}$DF_\text{pay}$ & \color{blue}rate & \color{blue}\multicolumn{1}{c}{expiry} & \color{blue}period & \color{blue}$T_\text{expiry}$ & \color{blue}$\Delta$ & \color{blue}\multicolumn{1}{c}{Caplet} \\
\midrule
...
\begin{frame}{Conclusions}
  ...
  \item \tb{Next steps:}
    \begin{enumerate}
    \item Install TeX Live locally (Overleaf doesn't work yet)
    \item Update all packages using TeX Live Manager (Windows) or TeX Live Utility (Mac)
